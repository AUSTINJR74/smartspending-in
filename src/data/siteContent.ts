...
const siteContent: SiteContent = {
  ...
  hero: {
    ...
    primaryCta: { label: "Get Free Consultation", href: "#booking" },
  ...
  testimonials: {
    ...
    items: [
      ...
      },
      {
        ...
        text: "I was confused about where to invest. SmartFinance created a clear roadmap — now I have a diversified portfolio and my SIPs are on autopilot. Highly recommend!",
        avatar: "RV",
        rating: 5,
      },
      {
      ...
      },
      {
        ...
        text: "As a founder, managing personal and business finances was overwhelming. SmartFinance simplified everything and helped me save over ₹5L last year.",
        avatar: "VP",
        rating: 5,
      },
      {
      ...
      },
      {
        ...
        text: "As a freelancer, tax optimization was my biggest headache. SmartFinance helped me legally save 40% on taxes and set up an emergency fund. Life-changing advice!",
        avatar: "AN",
        rating: 5,
      },
    ],
  ...
  footer: {
    ...
    copyright: `© ${new Date().getFullYear()} SmartFinance. All rights reserved.`,
  },
