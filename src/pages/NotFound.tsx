    ...
    <div className="flex min-h-screen items-center justify-center hero-gradient relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 space-y-6">
        ...
        >
          <Button
            size="lg"
            className="rounded-full px-10 h-14 text-lg font-bold gradient-bg text-white border-0 shadow-2xl shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-[1.03] transition-all duration-300 gap-2.5 cta-glow"
            asChild
          >
            <a href="/">
