...
const HowItWorks = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/3 w-[600px] h-[600px] rounded-full bg-blue-500/5 blur-[120px] pointer-events-none" />
      ...
      <div className="container-wide relative z-10">
        ...
        >
          ...
          <p className="text-white/50 text-base md:text-lg max-w-2xl mx-auto mt-5 leading-relaxed">
          ...
          {howItWorks.steps.map((step, i) => (
            ...
            >
              <div className="relative z-10 inline-flex flex-col items-center">
                {/* Step Number */}
                <div className="w-[5.5rem] h-[5.5rem] rounded-2xl glass-card-dark flex items-center justify-center mb-6 group hover:scale-105 transition-transform duration-300">
