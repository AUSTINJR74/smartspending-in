    ...
    >
      <div className="container-wide flex items-center justify-between h-[4.5rem] px-6 md:px-10">
        ...
        <div className="hidden lg:flex items-center gap-9">
          ...
          <Button size="sm" className="rounded-xl px-6 gradient-bg-white text-foreground border-0 shadow-md shadow-primary/15 hover:bg-white/90 hover:shadow-lg hover:shadow-primary/25 hover:scale-[1.02] transition-all duration-300" asChild>
            <a href={location.pathname !== "/" ? `/${bookingHref}` : bookingHref}>Get Free Guidance</a>
          </Button>
        </div>
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-background/95 backdrop-blur-xl border-b border-border">
          <div className="flex flex-col gap-1.5 px-6 py-5">
            ...
            <Button size="sm" className="mt-3 rounded-xl gradient-bg-white text-foreground border-0 hover:bg-white/90" asChild>
              <a href={location.pathname !== "/" ? `/${bookingHref}` : bookingHref} onClick={() => setMobileOpen(false)}>Get Free Guidance</a>
            </Button>
          </div>
        </div>
      )}
